    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          GetX<FetchImagesController>(initState: (context) {
            fetchImagesController.fetchImages();
          }, builder: (controller) {
                    ...
                    child: ListView(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 20, top: 10),
                              child: MyWidgets.textView(
                                  'Training Statistics', Colors.white, 17),
                            ),
                          ],
                        ),
                        Padding(
                        ...
                        SizedBox(
                          height: 220,
                          width: double.infinity,
                          child: Image.asset('assets/images/gym_g.png',
                              fit: BoxFit.cover),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 20, top: 10),
                              child: MyWidgets.textView(
                                  'Recent Workouts', Colors.white, 17),
                            ),
                          ],
                        ),
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: MyWidgets.textView(
                                    'Your workouts will be shown here as soon as you complete your first one. Start your workout now',
                                    Colors.white,
                                    12),
                              ),
                            ),
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(right: 20, top: 10),
                              child: MyWidgets.textView(
                                  'Past Challenges', Colors.white, 17),
                            ),
                          ],
                        ),
                        SizedBox(
                        ...
                        Container(
                            ...
                            child: MyWidgets.textView(
                                '     No Image Uploaded', Colors.white, 15)):
                        GridView.builder(
                                  ...
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image:
                                              NetworkImage(controller.list[index].imgUrl.toString()),
                                          fit: BoxFit.cover),
                                    ),
                                    child: Stack(
                                      children: [
                            ...
                            Expanded(
                              child: Padding(
                                padding:
                                    const EdgeInsets.only(left: 20, top: 10),
                                child: MyWidgets.textView(
                                    'Keep track of your progress - This pictures are only visible to you',
                                    Colors.white,
                                    12),
                              ),
                            ),
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 20, top: 10),
                              child: MyWidgets.textView(
                                  'Health & Nutrition', Colors.white, 17),
                            ),
                          ],
                        ),
                        Row(
                            ...
                            Expanded(
                              child: Padding(
                                padding:
                                    const EdgeInsets.only(left: 20, top: 10),
                                child: MyWidgets.textView(
                                    'Maximise you training result - with valuable health & nutrition tips',
                                    Colors.white,
                                    12),
                              ),
                            ),
