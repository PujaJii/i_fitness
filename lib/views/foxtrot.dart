  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: GetX<CatVideoController>(
          initState: (context) {
            catVideoController.getVideoList('0');
          },
          builder: (controller) {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            MyWidgets.textView('FoxTrot', Colors.white, 25),
                            Row(
                              children: [
                                InkWell(
                                    onTap: () {
                      ...
                      Row(
                        children: [
                          ...
                          MyWidgets.textView('   Estimated time : 9-17 min ', Colors.white, 14)
                        ],
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: NewView(controller.videoList[index].url!),
                                    ),const SizedBox(width: 20,),
